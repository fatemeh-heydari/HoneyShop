...
class Customer(models.Model):
    ...
    # phone field is not int because phonnumber has a 0 in the first and intfield dosent sho the first zero so we use of the charfield
...
class Profile(models.Model):
    ...
    # یوزری که میخواهیم پروفایلش را نمایش دهیم متصل میکنیم و تعیین میکنیم اگر یوزر حذف شد پروفایلش هم حذف شود
    date_modified = models.DateTimeField(User, auto_now= True)
    # برای اینکه نشان بدهد که کاربر چه زمانی پروفایلش را ادیت کرده
